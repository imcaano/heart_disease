...
class Web3Provider extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    try {
      _isLoading = true;
      // Don't call notifyListeners during initialization to avoid setState during build
      // notifyListeners();
  ...
  Future<void> _updateNetworkInfo(Object ethereum) async {
    try {
      ...
      // Don't call notifyListeners here as it might be called during initialization
      // notifyListeners();
    } catch (e) {
