...
class _UserAppointmentsScreenState extends State<UserAppointmentsScreen> {
            ...
            child: ConstrainedBox(
              ...
              child: IntrinsicHeight(
                child: Column(
                  ...
                  children: [
                    _buildAppointmentsList(context, constraints),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildAppointmentsList(BuildContext context, BoxConstraints constraints) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Icon(_getStatusIcon(appointment.status), size: 16, color: _getStatusColor(appointment.status)),
                              const SizedBox(width: 4),
                              Text(
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            _infoItem('Booked On', _formatDateTime(appointment.createdAt)),
                          ],
                        ),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: const [
                              ...
                              SizedBox(width: 8),
                              Text('Reason for Consultation', style: TextStyle(fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                        Padding(
