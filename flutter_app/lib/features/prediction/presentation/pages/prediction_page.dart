                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: null, child: Text('Choose Gender')),
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: null,
                              child: Text('Choose Fasting Blood Sugar')),
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: null, child: Text('Choose ECG Results')),
                          DropdownMenuItem(value: 0, child: Text('Normal')),
                          DropdownMenuItem(
                              value: 1, child: Text('ST-T wave abnormality')),
                          DropdownMenuItem(
                              value: 2,
                              child: Text('Left ventricular hypertrophy')),
                        ],
                        validator: (value) =>
                            value == null ? 'Please choose ECG results' : null,
                        onChanged: (value) {
                          setState(() {
                            _restecg = value;
                          });
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: null,
                              child: Text('Choose Exercise Induced Angina')),
                          DropdownMenuItem(value: 0, child: Text('No')),
                          DropdownMenuItem(value: 1, child: Text('Yes')),
                        ],
                        validator: (value) => value == null
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        validator: (value) =>
                            value == null ? 'Please choose slope' : null,
                        onChanged: (value) {
                          setState(() {
                            _slope = value;
                          });
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: null, child: Text('Choose Thalassemia')),
                          DropdownMenuItem(value: 0, child: Text('Normal')),
                          DropdownMenuItem(
                        ...
                        validator: (value) =>
                            value == null ? 'Please choose thalassemia' : null,
                        onChanged: (value) {
                          setState(() {
                            _thal = value;
                          });
